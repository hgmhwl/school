...
import net.school_a.app.adapter.RepairAdapter;
...
public class RepairFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(net.school_a.app.R.layout.fragment_main, container, false);
        recyclerView = (EasyRecyclerView) view.findViewById(net.school_a.app.R.id.easy_recyclerview);
        recyclerView.setErrorView(net.school_a.app.R.layout.view_net_error);
