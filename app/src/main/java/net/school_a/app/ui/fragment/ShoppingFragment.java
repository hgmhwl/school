...
import net.school_a.app.adapter.ShoppingDataAdapter;
import net.school_a.app.db.DBManager;
import net.school_a.app.model.bean.ListProductContentModel;
import net.school_a.app.ui.activity.ProductPayDetailActivity;
import net.school_a.app.ui.viewholder.ShoppingDataViewHolder;
import net.school_a.app.utils.BaseUtils;
import net.school_a.app.widget.PromptDialog;
