package net.school_a.app.model.http;

import net.school_a.app.model.bean.AppUserModel;
import net.school_a.app.model.bean.CommentOrderDataModel;
...
import net.school_a.app.model.bean.UserDataModel;
...
public interface HttpInterface {
    ...
    Call<ResponseBody> userLogin(@Path("action") String action, @PartMap Map<String, String> params);
     ...
     */
    @POST("/api/v1/user/{action}")
    Call<ResponseBody> userLogin1(@Path("action") String action, @Body AppUserModel appUserModel);
     ...
     * @return
     */
    @GET("/api/v1/adinfo/{action}")
    Observable<ResponseBody> getBanners(@Path("action") String action);

    @GET("/api/v1/adinfo/{action}")
    Call<ResponseBody> getBannersList(@Path("action") String action);
