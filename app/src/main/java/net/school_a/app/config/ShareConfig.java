package net.school_a.app.config;
...
public class ShareConfig {
    ...
    public void initSina() {
        ...
        sinaShareContent.setShareImage(new UMImage(context, net.school_a.app.R.mipmap.ic_launcher));
    ...
    public void initQQ() {
        ...
        qqShareContent.setShareContent("生意管家，为你提供最贴心的日常生意管理");
        qqShareContent.setTitle("精品");
        qqShareContent.setShareImage(new UMImage(context, net.school_a.app.R.mipmap.ic_launcher));
        qqShareContent.setTargetUrl("http://www.4006510871.cn/ticket/home/");
    ...
    public void initQQzone() {
        ...
        qzone.setTitle("洛克良品");
        qzone.setShareImage(new UMImage(context, net.school_a.app.R.mipmap.ic_launcher));
    ...
    public void initWeixin() {
        ...
        weiXinShareContent.setShareImage(new UMImage(context, net.school_a.app.R.mipmap.ic_launcher));
    ...
    public void initWXCircle() {
        ...
        circleShareContent.setShareImage(new UMImage(context, net.school_a.app.R.mipmap.ic_launcher));
