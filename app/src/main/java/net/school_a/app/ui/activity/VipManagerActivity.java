...
import net.school_a.app.adapter.VipAdapter;
 ...
 * 会员管理
 */
public class VipManagerActivity extends BaseThemeSettingActivity implements SwipeRefreshLayout.OnRefreshListener, RecyclerArrayAdapter.OnLoadMoreListener {
    ...
    private void initView() {
        ...
        adapter.setOnItemClickListener(new RecyclerArrayAdapter.OnItemClickListener() {
            ...
            public void onItemClick(int position) {
                ...
                Intent intent = new Intent(VipManagerActivity.this, SupplierDetailActivity.class);
    ...
    public void onRefresh() {
        handler.postDelayed(new Runnable() {
            ...
            public void run() {
                adapter.clear();
                adapter.addAll(DataProvider.getVipList(0));
            }
        }, 1000);
    }
    ...
    public void onLoadMore() {
        handler.postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                adapter.addAll(DataProvider.getVipList(page));
                page++;
            }
        }, 2000);
    }
