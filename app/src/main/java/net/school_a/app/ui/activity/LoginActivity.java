...
import net.school_a.app.api.ServiceApi;
import net.school_a.app.http.RetrofitHttp;
import net.school_a.app.model.RecommendModel;
import net.school_a.app.model.bean.AppUserModel;
import net.school_a.app.utils.AbMd5;
...
//                }
    ...
    private void getData() {
        ...
        //doLogin();
        loginHX(phone, password);
    }

    private void test() {
        RecommendModel.getBanners(new Callback<ResponseBody>() {
            @Override
    ...
    private void doLogin() {
        if (checkUpResult) {
            ...
            RetrofitHttp.getRetrofit(builder.build()).userLogin1("login", getObject(phone, AbMd5.MD5(password)))
    ...
    private AppUserModel getObject(String username, String password) {
        AppUserModel object = new AppUserModel();
        object.setMobile(username);
