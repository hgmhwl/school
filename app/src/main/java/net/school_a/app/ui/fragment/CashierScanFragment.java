...
import net.school_a.app.adapter.ScanGoodsAdapter;
...
public class CashierScanFragment extends Fragment implements SurfaceHolder.Callback {
    ...
    private List<TestGoods> list = new ArrayList<>();
    private ScanGoodsAdapter adapter;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_sale_scan, container, false);
        ButterKnife.bind(this, view);
        listView = (ListView) view.findViewById(R.id.sale_scan_list);
        surface_view = (SurfaceView) view.findViewById(R.id.surface_view);
    ...
    private void init() {
        adapter = new ScanGoodsAdapter(getActivity(), list);
    ...
    private void initBeepSound() {
        if (soundUtils == null) {
            soundUtils = new SoundUtils(getActivity(), SoundUtils.RING_SOUND);
    ...
    private TestGoods makeGoods() {
        TestGoods testGoods = new TestGoods();
        testGoods.setId("1");
        testGoods.setName("测试商品");
        testGoods.setCode("xxxx");
        testGoods.setPrice(30.0);
        testGoods.setStore(20);
        testGoods.setRes(R.mipmap.demo_list_icon_img5);
        return testGoods;
    }
}
