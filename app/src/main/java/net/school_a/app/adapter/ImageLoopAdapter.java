...
import net.school_a.app.ui.activity.SearchActivity;
...
public class ImageLoopAdapter extends DynamicPagerAdapter {
    ...
    public View getView(final ViewGroup container, final int position) {
        View view = LayoutInflater.from(container.getContext()).inflate(net.school_a.app.R.layout.view_rollviewpager, null);
        SimpleDraweeView mSimpleDraweeView =(SimpleDraweeView)view.findViewById(net.school_a.app.R.id.viewPager_img);
