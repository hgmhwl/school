...
import net.school_a.app.model.FindPassDataModel;
...
public class FindPasswordActivity extends BaseThemeSettingActivity {
    ...
    @BindView(net.school_a.app.R.id.btn_back)
    Button btn_back;


    @BindView(net.school_a.app.R.id.find_pass_phone)
    FloatLabelView passPhone;


    @BindView(net.school_a.app.R.id.find_pass_code)
    FloatLabelView passCode;


    @BindView(net.school_a.app.R.id.send_code)
    Button sendCode;


    @BindView(net.school_a.app.R.id.find_pass_new)
    FloatLabelView passNew;


    @BindView(net.school_a.app.R.id.find_pass_upadate_pass)
    Button updatePass;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(net.school_a.app.R.layout.activity_find_password);
    ...
    @OnClick({net.school_a.app.R.id.btn_back, net.school_a.app.R.id.find_pass_upadate_pass, net.school_a.app.R.id.send_code})
    public void clickBtn(View view) {
        ...
        switch (view.getId()) {
            case net.school_a.app.R.id.btn_back:
                finish();
                break;
            case net.school_a.app.R.id.find_pass_upadate_pass:
                ...
                break;
            case net.school_a.app.R.id.send_code:
                //发送验证码
                if (!TextUtils.isEmpty(phone)) {
        ...
        public void handleMessage(Message msg) {
            if (msg.what == 1) {
                if (time > 0) {
                    ...
                    sendCode.setBackground(getResources().getDrawable(net.school_a.app.R.drawable.send_code_button_click_bg));
                    sendCode.setTextColor(getResources().getColor(net.school_a.app.R.color.milk_white));
                    time--;
                    handlerText.sendEmptyMessageDelayed(1, 1000);
                } else {
                    sendCode.setText("发送验证码");
                    sendCode.setClickable(true);
                    sendCode.setBackground(getResources().getDrawable(net.school_a.app.R.drawable.button_register));
                    sendCode.setTextColor(getResources().getColor(net.school_a.app.R.color.login_btn_text_color));
                    time = 60;
                    flag = false;
                }
            } else if (msg.what == 2) {
